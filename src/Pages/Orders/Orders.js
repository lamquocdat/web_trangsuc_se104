        ...
        <table>
          <thead>
            <tr>
              ...
              <th>
                {' '}
                Customer <span class="icon-arrow"></span>
              </th>
              <th>
                {' '}
                Location <span class="icon-arrow"></span>
              </th>
              <th>
                {' '}
                Order Date <span class="icon-arrow"></span>
              </th>
              <th>
                {' '}
                Status <span class="icon-arrow"></span>
              </th>
              <th>
                {' '}
                Amount <span class="icon-arrow"></span>
              </th>
            </tr>
          </thead>
          <tbody>
