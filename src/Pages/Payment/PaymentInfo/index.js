        ...
        <div className={" d-flex justify-content-center"}>
            <div className="w-50">
                ...
                <div className="my-12 px-4 py-2">
                    ...
                    <div className={" d-flex justify-content-center my-4 "}>
                        <select className="text-center py-2 px-2 rounded" onChange={handleSelectChange}>
                            <option key={0} value="">-- Chọn ngân hàng --</option>
                    ...
                    <div className="text-center pb-1">
                        ...
                        <div className="d-flex justify-content-evenly my-4">
                            <select className="rounded px-2 py-2">
                                <option key="1" value="VN">Việt Nam</option>
                            </select>
                            <select value={province} onChange={handleProvinceChange} className="rounded px-2 py-2">
                            ...
                            <select value={district} onChange={handleDistrictChange} className="rounded px-2 py-2">
                            ...
                            <select value={ward} onChange={handleWardChange} className="rounded px-2 py-2">
                ...
                <div className="text-center my-4">
                    <Link to={{ pathname: `/paymentfinish/${madonhang}` }} className="rounded w-50 px-3 py-3 bg-primary text-white">Xác nhận</Link>
                </div>
            </div>
        </div>
    );
