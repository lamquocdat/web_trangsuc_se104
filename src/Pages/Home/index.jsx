        ...
        <Row className={"pb-5 pt-4 px-5 " + styles.line} >
          ...
          <Col className={styles.item}>
                <div className={styles.goods} >
                    <img src={require('../../assets/images/trang-suc-vang.png')} alt="" className={styles.pic}/>
          ...
          <h4 className="pb-3" style={{color:"blue"}}>Sản phẩm bán chạy</h4>
            <Col className={styles.item}>
                <div className={styles.goods}>
                    <img src={require('../../assets/images/trang-suc-vang.png')} alt="" className={styles.pic}/>
                    <div className={styles.name}>trang sức vàng</div>
                    <div className={styles.price} style={{color:"orange"}}><b>10.900.000đ</b></div>
                    
                    <div className={styles.count} ><b>1000</b>+ đã bán được</div>
